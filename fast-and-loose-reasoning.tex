...
\framesubtitle{It works}
\begin{center}
You cannot simultaneously fly the flag of static typing virtues and ignore parametricity.
\begin{itemize}
  \item<1> It is essential
  \item<2> It is fundamental
  \item<3> It is ubiquitous
\end{itemize}
\end{center}
\end{frame}
